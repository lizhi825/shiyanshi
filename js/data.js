...
const SiteData = {
    ...
    about: JSON.parse(localStorage.getItem('site_about') || JSON.stringify({
        intro: '哈尔滨理工大学海洋智能装备研究所（简称"海智所"）成立于2015年，是哈尔滨理工大学荣成学院首批成立的三个院级研究所之一，位于荣成学院一号实验楼401。研究所依托哈尔滨理工大学的学科优势，面向国家海洋强国战略，致力于海洋智能装备领域的前沿科学研究与关键技术攻关。',
        intro2: '研究所现有固定研究人员11人，其中副教授3人、讲师8人，在读学生15余人。下设海洋装备材料制备研究组、机电一体化研究组、金属精密成形研究组三个研究组，以创新性研发、解决实际问题、与企业进行项目合作作为研究特色，以培养学生专业技能和科研素养为目的，围绕海洋装备材料开展一系列纵向课题的研发。',
